# Generated by Django 4.0.4 on 2022-05-28 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=35, unique=True, verbose_name='Name')),
                ('icon', models.CharField(blank=True, null=True, max_length=60, validators=[django.core.validators.RegexValidator(message='Bitte nutzten Sie das folgende Format: "bi bi-<icon-name>"', regex='^bi bi-[a-z0-9-]+$')], verbose_name='Bootstrap-Icon (icons.getbootstrap.com)')),
                ('description', models.TextField(blank=True, max_length=280, null=True, verbose_name='Beschreibung')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment', models.TextField(max_length=280, verbose_name='Kommentar')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellt am')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Erstellt von')),
