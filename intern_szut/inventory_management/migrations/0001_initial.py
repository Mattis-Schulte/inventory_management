    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial_number', models.CharField(blank=True, max_length=35, null=True, verbose_name='Seriennummer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=280, null=True, verbose_name='Beschreibung')),
                ('status', models.IntegerField(choices=[(2, 'Offen'), (1, 'In Bearbeitung'), (0, 'Geschlossen')], verbose_name='Aktueller Status')),
