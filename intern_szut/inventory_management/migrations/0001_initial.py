# Generated by Django 4.0.4 on 2022-06-07 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_id', models.CharField(max_length=12, unique=True, verbose_name='itslearning Person-ID')),
                ('username', models.CharField(max_length=50, unique=True, verbose_name='Benutzername')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=560, null=True, verbose_name='Beschreibung')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=40, verbose_name='Titel')),
                ('description', models.TextField(max_length=560, verbose_name='Beschreibung')),
                ('status', models.IntegerField(choices=[(1, 'Offen'), (0, 'Geschlossen')], verbose_name='Aktueller Status')),
                ('created_at', models.DateTimeField(auto_now=True, verbose_name='Erstellt am')),
                ('last_change_at', models.DateTimeField(auto_now=True, verbose_name='Letzte Änderung am')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment', models.TextField(max_length=560, verbose_name='Antwort')),
                ('created_at', models.DateTimeField(auto_now=True, verbose_name='Erstellt am')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Erstellt von')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=35, unique=True, verbose_name='Name')),
                ('description', models.TextField(blank=True, max_length=560, null=True, verbose_name='Beschreibung')),
                ('building_section', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='inventory_management.buildingsection', verbose_name='Bauabschnitt')),
                ('floor', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='inventory_management.floor', verbose_name='Etage')),
            ],
            options={
                'verbose_name': 'Raum',
